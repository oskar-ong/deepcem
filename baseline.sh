...
echo "Running baseline for dataset / pollution level: $DATASET - $P"

# No need to pass number of tasks to srun
srun python src/exp_baseline.py --dataset "$DATASET" --pollution "$P"
echo "Completed baseline for dataset / pollution level: $DATASET - $P"
